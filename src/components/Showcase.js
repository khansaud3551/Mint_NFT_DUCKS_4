...
import img4 from "../assets/Nfts/pigoen-4.png";
import img5 from "../assets/Nfts/pigoen-5.png";
import img6 from "../assets/Nfts/pigoen-6.png";
import img7 from "../assets/Nfts/pigoen-7.png";
import img8 from "../assets/Nfts/pigoen-8.png";
import img9 from "../assets/Nfts/pigoen-9.png";
import img10 from "../assets/Nfts/pigoen-5.png";
...
const NftItem = ({ img, number = 0, price = 0, passRef }) => {
  ...
  return (
    ...
    >
      ...
      <Details className="showcase_bot">
        <div>
          <span className="showcase_text1">Weirdos</span> <br />
          <h1 className="showcase_title text-left mb-0">#{number}</h1>
        </div>

        <div>
          <span className="showcase_text2 text-right">Price</span>
          <Price>
...
const Showcase = () => {
  ...
  return (
    <Section id="showcase" className="container_showcase">
